...
export const questions = [
  {
    id: 1,
    question: "You are in Pallet Town to begin your Pokemon Training. What do you do next?",
    answers: [
      { text: "Head straight into the tall grass — growth only comes from battles.", weights: { fire: 3, water: 0, grass: 0, psychic: 0, electric: 1 } },
      { text: "Study the town's layout and plan the most efficient route first.", weights: { fire: 0, water: 0, grass: 1, psychic: 3, electric: 0 } },
      { text: "Talk to everyone until someone gives a useful tip.", weights: { fire: 0, water: 1, grass: 0, psychic: 0, electric: 3 } },
      { text: "Find a quiet spot before anything else.", weights: { fire: 0, water: 2, grass: 3, psychic: 0, electric: 0 } },
    ],
  },
  {
    id: 2,
    question: "Gary , your childhood rival, challenges you to a battle right now. How do you handle it?",
    answers: [
      { text: "Accept without hesitation — battle brings out the best in us both.", weights: { fire: 3, water: 0, grass: 0, psychic: 0, electric: 1 } },
      ...
      { text: "Size up his Pokémon first and decide based on what I observe.", weights: { fire: 0, water: 0, grass: 1, psychic: 3, electric: 0 } },
    ],
  },
  {
    id: 3,
  ...
  },
  {
    ...
    answers: [
      ...
      { text: "Write it all out in a long journal entry in my PokéDex.", weights: { fire: 0, water: 1, grass: 0, psychic: 3, electric: 0 } },
      { text: "Hang out with my Pokémon. Their comfort is enough.", weights: { fire: 0, water: 3, grass: 1, psychic: 0, electric: 0 } },
    ],
  },
  {
    id: 5,
    ...
    answers: [
      ...
      { text: "Trust that a stronger trainer will handle it — I know my limits.", weights: { fire: 0, water: 0, grass: 3, psychic: 1, electric: 0 } },
    ],
  },
]
